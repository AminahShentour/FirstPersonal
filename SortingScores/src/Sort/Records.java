...
class Records {
    ...
    public static void main(String[] args) {
        ...
        list.forEach(s->{
          ...
          Set<Entry<String, Integer>> entrySet2 = batch1Term1.entrySet();
          
          List<Entry<String, Integer>> list2 = new ArrayList(entrySet2);
          ...
          Set<Entry<String, Integer>> entrySet3 = batch1Term1.entrySet();
          
          List<Entry<String, Integer>> list3 = new ArrayList(entrySet3);
